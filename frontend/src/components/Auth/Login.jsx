...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    if (!validatePassword(password)) return toast.error("Password must contain at least 8 characters");
    ...
    <section className="authPage">
      <div className="banner">
        <div className="banner-content">
          <h1>Find your dream career with CareerBridge</h1>
          <p>Connect with companies, apply for jobs, and build your professional future.</p>
      ...
      <div className="auth-container">
        <div className="auth-card">
          <div className="header">
            ...
            <h3>Welcome Back</h3>
            <p>Login to continue exploring opportunities.</p>
          </div>
